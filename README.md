...
Если очистить БД и выполнить запросы в том порядке, который указывает первая цифра их названий - статус коды ответов будут совпадать с цифрой, идущей в названиях последней
